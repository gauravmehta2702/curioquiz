...
export default function sitemap():MetadataRoute.Sitemap{
 const staticRoutes=["","/quizzes","/categories","/search","/guides","/kids","/kids/play","/kids/curriculum","/kids/parents","/about","/faq","/contact","/methodology","/privacy","/terms","/disclaimer"];
 return [
