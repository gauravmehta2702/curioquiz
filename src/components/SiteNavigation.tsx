...
const links = [["/quizzes/","Quizzes"],["/categories/","Categories"],["/search/","Search"],["/kids/","CurioKids"],["/about/","About"]] as const;
export default function SiteNavigation(){
 ...
 return <header className="site-header"><div className="page-container navigation">
  <Link className="brand" href="/" aria-label="CurioQuiz homepage"><span className="brand-icon"><Brain size={24}/></span><span>CurioQuiz</span></Link>
