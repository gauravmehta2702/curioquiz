...
const links = [["/games/","Play Games"],["/quizzes/","Quizzes"],["/categories/","Explore"],["/search/","Search"],["/kids/","Kids & Learning"],["/guides/","Guides"],["/about/","About"]] as const;
export default function SiteNavigation(){
 ...
 return <header className="site-header"><div className="page-container navigation">
  ...
  <Link className="nav-action" href="/games/">Play now</Link>
